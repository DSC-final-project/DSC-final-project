...
class MenuManager:
    def __init__(self):
        ...
        '''
        self.menu_items = {
            "아메리카노": MenuItem("아메리카노", 2, 3000),
            "카페라떼": MenuItem("카페라떼", 5, 3500),
            "카페모카": MenuItem("카페모카", 6, 3800),
            "에스프레소": MenuItem("에스프레소", 3, 2500),
            "카푸치노":MenuItem("카푸치노", 5, 4000),
            "바닐라라떼":MenuItem("바닐라라떼", 6, 3800),
            "카라멜마끼아또" : MenuItem("카라멜마끼아또", 6, 4200),
            "캐모마일티" : MenuItem("캐모마일티", 9, 4500),
            "페퍼민트티" : MenuItem("페퍼민트티", 9, 4500),
            "블루베리에이드" :MenuItem("블루베리에이드", 3, 5000),
            "요거트스무디" : MenuItem("요거트스무디", 10, 5300),
            "블루베리스무디" : MenuItem("블루베리스무디", 10, 5300),
            "딸기스무디" : MenuItem("딸기스무디", 10, 5300),
            "커피번" : MenuItem("머핀", 8, 5000),
            "프레첼" : MenuItem("프레첼", 10, 4500),
            "마카롱" :MenuItem("마카롱", 1, 2000)
        }
